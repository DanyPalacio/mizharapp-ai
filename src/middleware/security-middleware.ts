...
export async function applySecurityMiddleware(
  ...
  // Perform comprehensive validation (admin maps to pro tier)
  const validationTier = tier === 'admin' ? 'pro' : tier;
  const validation = securityManager.validateRequest(request, clientId, validationTier);
